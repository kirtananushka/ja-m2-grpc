...
class PingPongServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PingPong = channel.unary_unary(
                '/com.tananushka.grpcdemo.grpc.PingPongService/PingPong',
...
def add_PingPongServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.tananushka.grpcdemo.grpc.PingPongService', rpc_method_handlers)
...
class PingPongService(object):
    ...
    def PingPong(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.tananushka.grpcdemo.grpc.PingPongService/PingPong',
